...
//       <div className='flex w-full max-w-screen-lg bg-white rounded-xl shadow-lg overflow-hidden'>
//         {/* Left side: Form */}
//         <div className='flex flex-col gap-3 w-1/2 p-8'>
//           <p className='text-2xl font-semibold'>{state === 'Sign Up' ? 'Create Account' : 'Login'}</p>
...
//   return (
//     <div className='flex w-full max-w-screen-lg bg-white rounded-xl shadow-lg overflow-hidden mt-16'>
//       {/* Left side: Form */}
//       <div className='flex flex-col gap-3 w-1/2 p-8'>
//         <p className='text-2xl font-semibold'>{state === 'Sign Up' ? 'Create Account' : 'Login'}</p>
//         <p>Please {state === 'Sign Up' ? 'sign up' : 'log in'} to book an appointment</p>
